                                ...
                                <div class="flex-table">
                                    ...
                                    <div class="flex-col">
                                        ...
                                        <p class="flex-content">
                                            ...
                                            {% if postList[i].isValidated == 1 %}<a href="/admin/update-post/{{ postList[i].id }}" class="btn btn-default btn-sm" title="Update post" target="_blank"><i class="now-ui-icons arrows-1_refresh-69"></i></a>{% endif -%}
