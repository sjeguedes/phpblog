...
class AppMailer
{
    ...
    public function sendContactFormMessageWithSMTP($datas, $insertionInfos, $sendingInfos)
    {
	    ...
	    $this->mailer->Body = '<p style="width:600px; margin: 0 auto; text-align:center;"><img src="' . $this->config::getParam('mailing.hostedImagesAbsoluteURL') . 'phpblog-logo.jpg" alt="phpBlog contact form" with="150" height="150"></p>' . PHP_EOL; // add custom header image
