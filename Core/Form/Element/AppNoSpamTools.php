...
class AppNoSpamTools
{
    ...
    /**
     * @var object: AppConfig instance - config to use
     */
    private $config;

    public function __construct($serviceParams)
    {
    ...
    public function setNoSpamFormValues($formValues = [])
    {
        ...
        // Single post page was called: comment form was just loaded!
        } else {
     ...
     * @return string|array: HTMl element tag string or an array of parameters to create HTML element
     */
    public function createHumanSwitchInput($print = false)
    {
