...
jQuery(function($) {
    ...
    // Slick slider for post list paging
    var postListSlider = $('.post-list-paging').slick({
        dots: true,
        infinite: false,
        speed: 300,
        slidesToShow: 1,
        slidesToScroll: 1,
        adaptiveHeight: true,
        appendArrows: $('.section-admin-post-list .slider-navigation'),
        appendDots: $('.section-admin-post-list .slider-navigation'),
        slide: '.slide-item',
