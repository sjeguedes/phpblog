...
jQuery(function($) {
    ...
    // Fix calls to scripts when page loaded for Safari: look at next script!
    ...
    // Slick slider for user list paging
    var userListSlider = $('.user-list-paging').slick({
        dots: true,
        infinite: false,
        speed: 300,
        slidesToShow: 1,
        slidesToScroll: 1,
        adaptiveHeight: true,
        appendArrows: $('.section-admin-user-list .slider-navigation'),
        appendDots: $('.section-admin-user-list .slider-navigation'),
        slide: '.slide-item',
        prevArrow: '<button type="button" class="slick-prev btn btn-link"><i class="btn btn-link now-ui-icons arrows-1_minimal-left"></i></button>',
        nextArrow: '<button type="button" class="slick-next btn btn-link"><i class="now-ui-icons arrows-1_minimal-right"></i></button>',
